...
export const D1_SCHOOLS = [
  ...
  'Pittsburgh','Stanford','Syracuse','Virginia Tech',
  // Big Ten (18)
  ...
  // Texas (Big 12 + others)
  'Texas','Texas State','Sam Houston State','Lamar','Stephen F. Austin',
  'UTSA','UT Arlington',
  // Sun Belt
  ...
  // American Athletic
  'Charlotte','East Carolina','Memphis','Navy','Temple','Tulane','Tulsa',
  'Wichita State',
  // Mountain West
