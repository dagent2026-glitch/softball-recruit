    ...
    <div className="min-h-screen bg-[#18181b] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#18181b] mt-2">Coach Login</h1>
          <p className="text-gray-500 text-sm mt-1">Welcome back — view your teams and rosters</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          No coach account?{' '}
          <Link href="/coach/signup" className="text-lime-700 font-semibold hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );
