    ...
    <div className="min-h-screen bg-[#18181b] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#18181b] mt-2">Forgot Password</h1>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          <Link href="/login" className="text-lime-700 font-semibold hover:underline">Back to login</Link>
        </p>
      </div>
    </div>
  );
